...
public class ContentsTextFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        contentsName = bundle.getString("contentsName");

        //마지막으로 읽은 페이지 불러오기
        db = dbHelper.getReadableDatabase();
        page = dbHelper.getContentsLastPage(contentsName);
        Log.d("DEBUGTAG", "해당 콘텐츠 마지막 페이지 = "+page);
    ...
    public void onPause() {//탭 이동 간 페이지 데이터 공유
        ...
        dbHelper.setContentsLastPage(contentsName, page);
    }
